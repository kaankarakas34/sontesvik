...
import { DocumentTypeFormData, documentTypesService } from '../../services/documentTypesService';
...
const CreateDocumentType: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await documentTypesService.createDocumentType(apiData);
      toast.success('Belge türü başarıyla oluşturuldu');
      navigate('/admin/document-types');
    } catch (error) {
      console.error('Error creating document type:', error);
      toast.error('Belge türü oluşturulurken bir hata oluştu');
    } finally {
      setLoading(false);
    }
  };
